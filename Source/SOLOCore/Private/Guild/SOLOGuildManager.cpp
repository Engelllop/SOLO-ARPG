...
// â”€â”€â”€ HasGuildPermission (implementacion global definida en Types) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
FGuildMember* USOLOGuildManager::FindMemberInGuild(FGuildData& Guild,
...
bool USOLOGuildManager::CanPerformAction(const FGuildData& Guild,
...
void USOLOGuildManager::NotifyGuildMembersUpdated(const FString& GuildID)
{
    ...
    for (FConstPlayerControllerIterator It = World->GetPlayerControllerIterator(); It; ++It)
    {
        ...
        USOLOGuildComponent* GuildComp =
            PS->FindComponentByClass<USOLOGuildComponent>();
...
// â”€â”€â”€ BUSQUEDA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

FGuildData* USOLOGuildManager::FindGuild(const FString& GuildID)
{
    return ActiveGuilds.Find(GuildID);
}

FGuildData* USOLOGuildManager::FindGuildByName(const FString& GuildName)
{
...
// â”€â”€â”€ CREACION DE GREMIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::CreateGuild(const FString& GuildName,
...
// â”€â”€â”€ INVITACION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::InvitePlayer(const FString& InviterID,
                                                          ...
                                                          const FString& GuildID)
{
    ...
    USOLOGuildComponent* TargetComp = nullptr;
...
// â”€â”€â”€ EXPULSION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::KickMember(const FString& KickerID,
...
// â”€â”€â”€ ASCENSO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::PromoteMember(const FString& PromoterID,
                                                           const FString& TargetID,
                                                           const FString& GuildID)
{
    FGuildData* Guild = FindGuild(GuildID);
...
// â”€â”€â”€ DESCENSO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::DemoteMember(const FString& DemoterID,
                                                          const FString& TargetID,
                                                          const FString& GuildID)
{
    FGuildData* Guild = FindGuild(GuildID);
...
// â”€â”€â”€ DISOLUCION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::DisbandGuild(const FString& RequestingPlayerID,
                                                          const FString& GuildID)
{
    FGuildData* Guild = FindGuild(GuildID);
    if (!Guild)
...
// â”€â”€â”€ BANCO DEL GREMIO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::DepositToBank(
    const FString& PlayerID,
    const FString& GuildID,
    int32 Amount,
...
EGuildRequestResult USOLOGuildManager::WithdrawFromBank(
    const FString& PlayerID,
    const FString& GuildID,
    int32 Amount,
    USOLOInventoryComponent* PlayerInventory)
...
// â”€â”€â”€ MENSAJE DEL DIA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

EGuildRequestResult USOLOGuildManager::UpdateMotD(const FString& PlayerID,
                                                        const FString& GuildID,
...
// â”€â”€â”€ PROGRESION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

void USOLOGuildManager::AddGuildXP(const FString& GuildID, int32 XPAmount)
{
    FGuildData* Guild = FindGuild(GuildID);
    if (!Guild || XPAmount <= 0)
    {
