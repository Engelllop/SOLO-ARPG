#include "AbilitySystem/SOLODamageExecCalc.h"
...
static const FSOLODamageStatics& DamageStatics()
{
	static FSOLODamageStatics Statics;
	return Statics;
}

USOLODamageExecCalc::USOLODamageExecCalc()
{
...
void USOLODamageExecCalc::Execute_Implementation(
	...
	OUT FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
	...
	OutExecutionOutput.AddOutputModifier(
		FGameplayModifierEvaluatedData(
			USOLOAttributeSet::GetIncomingDamageAttribute(),
