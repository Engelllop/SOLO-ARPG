...
#include "SOLOCharacterBase.generated.h"
...
/**
 * Clase base para todos los personajes de SOLO (jugador, enemigos, NPCs).
 ...
 */
UCLASS(Abstract)
class SOLOCORE_API ASOLOCharacterBase
	: public ACharacter
...
protected:
	...
	// Inicializa los atributos base vÃ­a GameplayEffect (en el GE se definen los valores por raza/clase)
	...
	// Habilidades que se conceden al comenzar (ataque bÃ¡sico, dash, etc.)
	...
	// Niagara a instanciar en el punto de impacto al recibir daÃ±o
	...
	// Montaje de animaciÃ³n de muerte
	...
	// GAS components â€” el jugador los obtiene del PlayerState, los enemigos los tienen aquÃ­
	UPROPERTY()
