...
class SOLOCORE_API UWG_VitalBars : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	/** Establece los valores numÃ©ricos para mostrar al lado de las barras */
	UFUNCTION(BlueprintCallable, Category = "VitalBars")
...
protected:
	...
	// Delayed ghost bar â€” mirrors HealthPercent but lerps at 2.0/s (Dark Souls feel)
	UPROPERTY(BlueprintReadOnly, Category = "VitalBars|State")
	...
	// Blueprint handles the actual visual update â€” C++ drives the data
...
private:
	// Display values â€” interpolated each tick toward their targets
