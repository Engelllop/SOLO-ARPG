...
struct SOLOCORE_API FStatusEffectData
{
	GENERATED_BODY()
...
/**
 * Status effects widget â€” muestra buffs/debuffs activos como iconos pequeÃ±os.
 * Aparece junto a las vital bars o en posiciÃ³n configurable.
 */
UCLASS(BlueprintType, Blueprintable)
class SOLOCORE_API UWG_StatusEffectsWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	/** AÃ±ade o actualiza un efecto individual */
	UFUNCTION(BlueprintCallable, Category = "StatusEffects")
