...
struct SOLOCORE_API FQuestLogEntry
{
	GENERATED_BODY()
 ...
 * Muestra la misiÃ³n principal colapsada por defecto, expande al hover.
 * Estilo sketchy â€” bordes tenues, colores cÃ¡lidos.
 */
UCLASS(BlueprintType, Blueprintable)
class SOLOCORE_API UWG_QuestLogWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	/** AÃ±ade o actualiza una entrada individual */
	UFUNCTION(BlueprintCallable, Category = "QuestLog")
