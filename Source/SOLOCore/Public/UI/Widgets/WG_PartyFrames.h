...
struct SOLOCORE_API FPartyMemberData
{
	GENERATED_BODY()
...
class SOLOCORE_API UWG_PartyFrames : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	// Hides the entire frame list â€” called when party size drops to 1
	UFUNCTION(BlueprintCallable, Category = "PartyFrames")
...
private:
	// Light-weight HP polling â€” runs every 0.5s instead of every tick
