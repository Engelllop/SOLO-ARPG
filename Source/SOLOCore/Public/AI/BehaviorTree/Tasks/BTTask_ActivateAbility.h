...
UCLASS(ClassGroup = (SOLO), meta = (DisplayName = "Activate Ability"))
class SOLOCORE_API UBTTask_ActivateAbility : public UBTTaskNode
{
	GENERATED_BODY()
...
protected:
	// Tag of the GameplayAbility to activate â€” set in the BT editor per node instance
