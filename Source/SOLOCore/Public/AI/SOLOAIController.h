...
#include "SOLOAIController.generated.h"

class UAbilitySystemComponent;

UCLASS(ClassGroup = (SOLO), meta = (BlueprintSpawnableComponent))
class SOLOCORE_API ASOLOAIController : public AAIController
{
	GENERATED_BODY()
...
public:
	...
	// Blackboard key names â€” used by all BT nodes to avoid magic strings
