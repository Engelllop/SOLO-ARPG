...
UCLASS()
class SOLOCORE_API UGA_Dodge : public USOLOGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	/** DuraciÃ³n del GameplayEffect que aplica State.Invulnerable (i-frames). */
	...
	/**
	 * GE con duraciÃ³n, tag State.Invulnerable en InheritableGameplayTagContainer.
	 * Por defecto se usa USOLO_GE_DodgeInvulnerability si no se asigna otro.
	 */
