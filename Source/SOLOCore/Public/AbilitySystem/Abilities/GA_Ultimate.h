...
/**
 * Ultimate base: montaje â†’ evento de impacto â†’ Ã¡rea de daÃ±o, stagger, knockback y VFX.
 * Cooldown: Cooldown.Ability.Ultimate (via GetCooldownTags + CooldownEffect).
 */
UCLASS()
class SOLOCORE_API UGA_Ultimate : public USOLOGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	/** GE con duraciÃ³n y tag Cooldown.Ability.Ultimate (configurar duraciÃ³n en el asset o vÃ­a ApplyCooldown). */
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Ultimate|Cooldown")
