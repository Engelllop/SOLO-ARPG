...
#define LOCTEXT_NAMESPACE "EMBERVEILQuestLog"
...
void UWG_QuestLogWidget::NativeOnMouseLeave(const FPointerEvent& InMouseEvent)
{
	...
	// Volver a estado colapsado (solo título de misión principal)
	RebuildList();
}
...
{
	// No necesitamos reconstruir aquí porque los rows manejan su propia visibilidad
	// Este método se llama para refresh si hay cambios de data
}
