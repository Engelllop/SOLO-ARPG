...
UGE_Poison::UGE_Poison()
{
	...
	Duration     = 5.f;
	TickInterval = 1.f;
	// DamagePerTick is left at 0 intentionally — we install the SetByCaller
...
void UGE_Poison::PostInitProperties()
{
	...
	// before applying the spec. The default tag magnitude is 5.0 — GAS uses that
