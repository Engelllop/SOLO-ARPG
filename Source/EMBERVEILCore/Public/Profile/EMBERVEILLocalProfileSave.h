...
#include "EMBERVEILLocalProfileSave.generated.h"
 ...
 * Perfil ligero (DisplayName) y datos de partida ampliables (nivel, posición, quests, etc.).
 */
UCLASS()
class EMBERVEILCORE_API UEMBERVEILLocalProfileSave : public USaveGame
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(SaveGame)
	EEMBERVEILClass SavedClass = EEMBERVEILClass::Warrior;

	UPROPERTY(SaveGame)
	EEMBERVEILRace SavedRace = EEMBERVEILRace::Human;
