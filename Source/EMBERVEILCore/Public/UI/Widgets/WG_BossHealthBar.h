...
class EMBERVEILCORE_API UWG_BossHealthBar : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "BossBar")
	void SetBossReference(AEMBERVEILEnemyCharacter* Boss);
	...
	/** Enlaza el widget a un jefe específico, registrando delegates de GAS. */
	UFUNCTION(BlueprintCallable, Category = "BossBar")
	void BindToBoss(AEMBERVEILEnemyCharacter* Boss);
...
private:
	TWeakObjectPtr<AEMBERVEILEnemyCharacter> CachedBoss;
