...
struct EMBERVEILCORE_API FBattleLogEntry
{
	GENERATED_BODY()
 ...
 * Por defecto muestra solo los últimos 2 mensajes.
 * Al hacer hover expande a lista completa con colores por tipo.
 * Estilo sketchy — igual que el quest log.
 */
UCLASS(BlueprintType, Blueprintable)
class EMBERVEILCORE_API UWG_BattleLogWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	/** Añade una entrada al log y descarta las más viejas si excede el límite */
	...
	/** Número máximo de entradas que se mantienen en el log */
	UPROPERTY(EditAnywhere, Category = "BattleLog")
	int32 MaxEntries = 50;

	/** Número de entradas visibles en modo colapsado */
	UPROPERTY(EditAnywhere, Category = "BattleLog")
