...
struct EMBERVEILCORE_API FEMBERVEILAbilitySlot
{
	GENERATED_BODY()
...
class EMBERVEILCORE_API UWG_AbilityBar : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	// Called whenever the player's level changes — unlocks newly eligible slots
	...
	TArray<FEMBERVEILAbilitySlot> AbilitySlots;
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "AbilityBar|Events")
	void BP_UpdateSlot(int32 SlotIndex, const FEMBERVEILAbilitySlot& SlotData);
