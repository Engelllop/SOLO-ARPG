...
class EMBERVEILCORE_API UWG_MainHUD : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	// Called by AEMBERVEILHUDBase to wire up minimap toggle
	void ToggleMinimap();

protected:
	// Sub-widget bindings — Blueprint must contain widgets with these exact names
...
private:
	...
	// Attribute change callbacks — bound via ASC delegate system
