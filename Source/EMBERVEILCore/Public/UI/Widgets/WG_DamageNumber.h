...
class EMBERVEILCORE_API UWG_DamageNumber : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	/** Inicia el número de daño. InLifetime = tiempo hasta Deactivate (pool). */
	...
	// Returns this widget to the pool — called at end of lifetime
	void Deactivate();
