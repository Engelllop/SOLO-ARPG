...
#include "EMBERVEILGuildManager.generated.h"
 ...
 *
 * Uso:
 *   UEMBERVEILGuildManager* GuildMgr =
 *       GetGameInstance()->GetSubsystem<UEMBERVEILGuildManager>();
 */
UCLASS()
class EMBERVEILCORE_API UEMBERVEILGuildManager : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
     ...
     * En produccion online estos datos vendrían de un backend persistente.
     */
