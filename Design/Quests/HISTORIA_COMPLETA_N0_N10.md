# SOLO — Historia Completa: N0 a N10
### La Aventura del Jugador en Solitario

> **Nota de diseño:** Los pisos N0–N10 constituyen el contenido narrativo principal del modo un jugador. Este documento es el índice maestro actualizado — cada piso tiene su propio archivo con historia completa, peleas y diálogos.
...
## DESCRIPCIÓN DETALLADA DE CADA PISO

### N0 — Emberveil (Overworld)
El mundo exterior. Un paisaje devastado donde el sol no sale. El protagonista comienza aquí con Caín, su amigo de toda la vida. Juntos encuentran la entrada a la Torre: una grieta en la tierra que huele a ceniza y promesas rotas.

### Guardián de la Primera Garganta
El primer jefe de la Torre. Un coloso de piedra y sombra que guarda la entrada a N1. Caín muere aquí — no por error del jugador, sino por diseño narrativo. Su muerte es el primer recordatorio de que la Torre no perdona. La espada de Caín puede llevarse como recuerdo.
...
### El Protagonista
Llega sin pasado definido. Sale sabiendo que es un Persistente — un error en el Tejido que sobrevivió a compilaciones anteriores. El Arquitecto lo reconoce y lo respeta como su mejor "colección" hasta ahora.
...
- **N2, N4, N6, N8 son biomas sin ciudad** — campamento/refugio en cada uno
- **N3, N5, N7, N9 son ciudades** — descanso, mejoras, NPCs, misiones
